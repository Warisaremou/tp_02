...
@section('content')
    <div class="container" style="max-width: 50rem;">
        ...
        <div class="card">
            <div class="card-body">
                <h3 class="card-title fw-medium mb-5 text-center">Modifier un emprunt</h3>

                <form method="POST" action="{{ route('emprunt.update', $emprunt[0]->id_emprunt) }}" class="card-text">
                    {{ method_field('patch') }}
                    @csrf
                    <div class="row my-3">
                        ...
                        <div class="col-md-6">
                            <select name="id_livre"
                                ...
                                @foreach ($livres as $livre)
                                    <option
                                        {{ old('id_livre', $emprunt[0]->id_livre) == $livre->id_livre ? 'selected' : '' }}
                                        name="{{ $livre->titre }}" value="{{ $livre->id_livre }}">
                                        {{ $livre->titre }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6">
                            <select name="id_etudiant"
                                ...
                                @foreach ($etudiants as $etudiant)
                                    <option
                                        {{ old('id_etudiant', $emprunt[0]->id_etudiant) == $etudiant->id_etudiant ? 'selected' : '' }}
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="date_emprunt" type="date"
                                ...
                                autofocus value="{{ old('date_emprunt', $emprunt[0]->date_emprunt) }}">
                            @error('date_emprunt')
                                <span class="invalid-feedback text-start" role="alert">
                                    <p>{{ $message }}</p>
                                </span>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="date_retour_prevue" type="date"
                                ...
                                value="{{ old('date_retour_prevue', $emprunt[0]->date_retour_prevue) }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="date_retour_effective" type="date"
                                ...
                                value="{{ old('date_retour_effective', $emprunt[0]->date_retour_effective) }}">
